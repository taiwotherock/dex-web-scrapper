...
const save_price_1 = require("./save-price");
async function run() {
    ...
    const browser = await playwright_1.chromium.connectOverCDP('ws://127.0.0.1:9242/devtools/browser/41aeac2b-fa43-4ded-9297-a5525bb1e44e');
    ...
    for (i = 0; i < 100; i++) {
        ...
        (0, save_price_1.insertData)(symbol, convertStringMK(marketCap), convertStringMK(liquidity), convertStringMK(price), (0, save_price_1.getMySQLDateNow)(), convertStringMK(volume));
    }
