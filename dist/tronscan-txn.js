...
exports.fetchchaintran = fetchchaintran;
const playwright_1 = require("playwright");
async function fetchchaintran(chainUrl, chromeUrl) {
    //connect the existing browser using Websocket debugger address
    const browser = await playwright_1.chromium.connectOverCDP(chromeUrl); //'ws://127.0.0.1:9242/devtools/browser/21c1542d-cba3-4186-9a94-eb2ada6db3c5');
